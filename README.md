...
- Foram excluídos nos datasets armazenados no GitHub (fonte secundária) os nomes completos dos candidatos, permanecendo o primeiro nome do candidato associado ao seu respectivo número de inscrição.
