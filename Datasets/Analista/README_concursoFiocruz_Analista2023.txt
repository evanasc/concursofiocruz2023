Nota: As informações abaixo são apenas para o conjunto de dados: cargosDistribuicao_Analista.csv
...
Unidades e Órgãos Seccionais: Auditoria; Bio-Manguinhos; COC; Cogead; Cogepe; Cogeplan; Cogetic; Cogic; Corregedoria; ENSP; EPSJV; Farmanguinhos; Fiocruz Ceará; Fiocruz Mato Grosso do Sul; Fiocruz Rondônia; Gereb; IAM; ICC; Icict; ICTB; IFF; IGM; ILMD; INCQS; INI; IOC; IRR; Ouvidoria
...
Nota: As informações abaixo são apenas para o conjunto de dados: Novo-Relatorio-Analistas-ResFinal-Objetiva.csv
...
Nota: As informações abaixo são apenas para o conjunto de dados: Classificacao-Provisoria-Analistas-AntesDiscur.csv
