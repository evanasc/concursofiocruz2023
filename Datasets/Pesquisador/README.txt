Nota: As informações abaixo são apenas para o conjunto de dados: cargosDistribuicao_Pesquisador.csv
...
Q1plusQ2_minimo: Nota mínima por cargo para ser aprovado (corresponde a soma de Q1 e de Q2).
...
Nota: As informações abaixo são apenas para o conjunto de dados: Pesquisadores-Rel-ResFinal-Discursiva.csv
...
Q1: Nota atribuída na avaliação final da questão Q1 da Prova Discursiva refrente a área de atuação.
Q2: Nota atribuída na avaliação final da questão Q2 da Prova Discursiva refrente a área de atuação.
NFDiscur: Nota atribuída ao somatório da nota obtida entre Q1 e Q2 multiplicada pelo peso do respectivo perfil/cargo.
...
Nota: As informações abaixo são apenas para o conjunto de dados: Pesquisadores-Rel-Classificacao-Provisoria.csv
...
Class: Indica apenas a ordenação alfabética dos nomes dos candidatos para o respectivo cargo.
...
NFDiscur: Nota atribuída ao somatório da nota obtida entre Q1 e Q2 multiplicada pelo peso do respectivo perfil/cargo.
Habilitado: Indica se o candidato foi selecionado para a próxima etapa do processo seletivo, que neste caso a entrega de títulos. Valores: Sim ou Não. 
